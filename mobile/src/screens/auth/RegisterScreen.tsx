...
export default function RegisterScreen() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            if (msg.includes('email-already-in-use')) setError('Email is already registered');
        ...
        >
            ...
            <View style={styles.content}>
                ...
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.subtitle}>Join SwapSmith to start trading with AI.</Text>
                </View>
                ...
                >
                    <Text style={styles.registerBtnText}>Sign in to existing account</Text>
                </TouchableOpacity>
