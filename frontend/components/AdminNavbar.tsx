...
import { BarChart2, Users, ArrowLeftRight, Coins, RefreshCw, LogOut, Menu, X, LineChart } from 'lucide-react'

export type AdminPage = 'dashboard' | 'users' | 'swaps' | 'coins' | 'stats'
