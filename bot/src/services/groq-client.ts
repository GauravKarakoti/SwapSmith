...
7. "Send 5 USDC to vitalik.eth"
   -> intent: "swap", fromAsset: "USDC", toAsset: "USDC", toChain: "ethereum", amount: 5, settleAddress: "vitalik.eth", confidence: 95

8. "Swap 0.01 ETH to vitalik.eth"
   -> intent: "swap", fromAsset: "ETH", toAsset: "ETH", toChain: "ethereum", amount: 0.01, settleAddress: "vitalik.eth", confidence: 95

9. "Transfer 10 USDC to example.crypto"
   -> intent: "swap", fromAsset: "USDC", toAsset: "USDC", toChain: "ethereum", amount: 10, settleAddress: "example.crypto", confidence: 95
`;
